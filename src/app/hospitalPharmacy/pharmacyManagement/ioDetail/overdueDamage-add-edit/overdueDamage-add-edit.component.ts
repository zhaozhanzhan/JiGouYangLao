...
export class OverdueDamageAddComponent implements OnInit {
  selectedGoods = {
    drugName: "", //药品名称
    autoNum: 1, //第几个数据
    medDrugsId: "", //药品id,
  ...
  ngOnInit() {
    ...
    let dataInfo = JSON.parse(this.route.snapshot.paramMap.get("dataInfo"));
    ...
    if (dataInfo) {
      ...
      this.selectedGoods.drugName = dataInfo.medDrug.drugName;
      this.selectedGoods.medDrugsId = dataInfo.medDrug.id;
      this.selectedGoods.batchNum = dataInfo.batchNum;
      this.selectedGoods.mdBatchNum = dataInfo.mdBatchNum;
      this.selectedGoods.odNum = dataInfo.quantity;
      this.selectedGoods.reason = "过期";
      this.selectedGoods.manufacturers = dataInfo.medDrug.manufacturers;
      this.selectedGoods.specification = dataInfo.medDrug.specification;
      this.selectedGoods.inDate = dataInfo.inDate;
      this.selectedGoods.quantity = dataInfo.quantity;
      this.selectedGoods.supplier = dataInfo.supplier;
