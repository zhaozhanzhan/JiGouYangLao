...
@Component({
  selector: "app-send-med-list",
  templateUrl: "./send-med-list.component.html",
  styleUrls: ["./send-med-list.component.css"]
})
export class SendMedListComponent implements OnInit {
  /**
   {"page": "页码",
   "size": "每页数量",
   "search": "药品名称或者拼音首字母",
  ...
  */
  ...
  getList(reset: boolean = false): void {
    ...
    this.httpReq.post(
      "medRoomInventory/listOutInventory",
      null,
      this.sendData,
      data => {
        this.Loading = false;
