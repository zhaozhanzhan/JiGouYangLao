...
export class AddComponent implements OnInit {
        ...
        if (data["status"] == 200) {
          if (data["code"] == 0) {
            ...
            if (data["data"]["department"]) {
              this.reqObjGoodName = data["data"]["department"]["name"];
            }
  ...
  personalInfoOk(): void {
    if (
      this.personalInfoObj.name == "" ||
      this.personalInfoObj.phone == "" ||
      this.personalInfoObj.domesticCelation == ""
    ) {
  ...
  jobInfoOk(): void {
    ...
    if (
      this.emergencyContactObj.etime == "" ||
      this.emergencyContactObj.resignationTime == "" ||
      this.emergencyContactObj.unit == "" ||
      this.emergencyContactObj.operatingPost == ""
    ) {
