...
@Component({
  selector: "app-giveout-list1",
  templateUrl: "./giveout-list1.component.html",
  styleUrls: ["./giveout-list1.component.css"]
})
export class GiveoutList1Component implements OnInit {
  list = [];
