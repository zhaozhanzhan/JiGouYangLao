 ...
 * @LastEditTime: 2019-09-10 16:30:57
 * @Description:
 */
...
export class CloseAccountComponent implements OnInit {
  ...
  getInfo(id) {
    ...
    this.httpReq.post('outSettlement/get', null, { oldManInfo: id }, res => {
  ...
  setSettleStatus(status) {
    ...
    this.httpReq.post('outSettlement/update', null, { oldManInfo: this.payRecordId, status }, res => {
