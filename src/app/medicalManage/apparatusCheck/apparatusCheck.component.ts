...
@Component({
  selector: "app-apparatusCheck",
  templateUrl: "./apparatusCheck.component.html",
  styleUrls: ["./apparatusCheck.component.css"]
})
export class ApparatusCheckComponent implements OnInit {
  ...
  public getInfo() {
    ...
    this.httpReq.post("qmjc_report/list", null, reqObj, (data: any) => {
      if (data["code"] == 0) {
  ...
  public saveForm() {
    ...
    this.httpReq.post("qmjc_report/save", null, sendData, (data: any) => {
      if (data["code"] == 0) {
