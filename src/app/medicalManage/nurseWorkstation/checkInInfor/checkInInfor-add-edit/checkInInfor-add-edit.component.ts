...
@Component({
  selector: "app-checkInInfor-add-edit",
  templateUrl: "./checkInInfor-add-edit.component.html",
  styleUrls: ["./checkInInfor-add-edit.component.css"]
})
export class CheckInInforAddEditComponent implements OnInit {
  ...
  ngOnInit() {
    this.validateForm = this.fb.group({
      ...
      careLevelCase: ["", [Validators.required]], //"护理级别",
      sickWardId: ["", [Validators.required]], //"病区Id",
      bedId: ["", [Validators.required]], //"床位Id",
      situation: ["", [Validators.required]], //"入院时情况",
      judgement: "", //"门(急)诊断",
      accountId: "", //"登陆账户Id",
      comment: "", //"入院备注"
      bedName: ""
