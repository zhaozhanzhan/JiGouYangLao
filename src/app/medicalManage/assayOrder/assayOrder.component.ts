...
@Component({
  selector: "app-assayOrder",
  templateUrl: "./assayOrder.component.html",
  styleUrls: ["./assayOrder.component.css"]
})
export class AssayOrderComponent implements OnInit {
  ...
  /**
   * 获取详情
   * @memberof AssayOrderComponent
   */
  public getInfo() {
    const reqObj: any = {};
    reqObj.inHospitalInfoId = this.patientId; // 病人基本信息id
    this.httpReq.post("xnfcghy_report/list", null, reqObj, (data: any) => {
      if (data["code"] == 0) {
  ...
  public saveForm() {
    ...
    this.httpReq.post("xnfcghy_report/save", null, sendData, (data: any) => {
      if (data["code"] == 0) {
