...
export class MedicalRecordComponent implements OnInit {
  ...
  public printStyle: string = `
    ...
    #medicalRecord .cusTable {
        border-collapse: collapse;
        border: 1px solid black !important;
    }
    #medicalRecord .cusTable td {
        border: 1px solid black !important;
        height: 30px !important;
    }
    #medicalRecord div,span,input,table,tr,td{
      font-size: 8pt !important;
    }
    #medicalRecord .ftzPt10{
        font-size: 10pt !important;
    }
    #medicalRecord .ftzPt11{
        font-size: 11pt !important;
    }
    #medicalRecord .ftzPt12{
        font-size: 12pt !important;
    }
    #medicalRecord .ftzPt13{
        font-size: 13pt !important;
    }
    #medicalRecord .ftzPt14{
        font-size: 14pt !important;
    }
    #medicalRecord .ftzPt15{
        font-size: 15pt !important;
    }
    #medicalRecord .ftzPt16{
        font-size: 16pt !important;
    }
    #medicalRecord .ftzPt17{
        font-size: 17pt !important;
    }
    #medicalRecord .ftzPt18{
        font-size: 18pt !important;
    }
    #medicalRecord .ftzPt19{
        font-size: 19pt !important;
    }
    #medicalRecord .ftzPt20{
        font-size: 20pt !important;
    }
    #medicalRecord .ant-select-selection--single {
      height: 32px;
      position: relative;
      cursor: pointer;
    }
    #medicalRecord .ant-select-selection {
      outline: 0;
    ...
    #medicalRecord .ant-select-search--inline .ant-select-search__field {
      border-width: 0;
      font-size: 100%;
      height: 100%;
      width: 100%;
    ...
    #medicalRecord .ant-select-selection__rendered {
      display: block;
      margin-left: 11px;
      margin-right: 11px;
      position: relative;
    ...
    #medicalRecord .ant-select-search__field__placeholder, .ant-select-selection__placeholder {
      position: absolute;
      top: 50%;
      left: 0;
      right: 9px;
    ...
    #medicalRecord .ant-select-selection-selected-value {
      float: left;
      overflow: hidden;
      text-overflow: ellipsis;
      white-space: nowrap;
    ...
    #medicalRecord .ant-select-search--inline {
      position: absolute;
      height: 100%;
      width: 100%;
    }
    #medicalRecord .ant-select-selection__rendered:after {
      content: '.';
      visibility: hidden;
      pointer-events: none;
    ...
    #medicalRecord .ant-select-arrow, .ant-select-selection__clear {
      opacity:0;
    }
    #medicalRecord .ant-input-disabled {
      background-color: transparent !important;
      color:#000 !important;
    }
    #medicalRecord @media print {
      /* @page {
        size: 210mm 290mm​;
        margin: 0mm auto;
      } */
  ...
  public formData: any = {
    ...
    medRecordDiagnoseInfo: [
      ...
      {
        diagnoseId: "",
        outHospitalDiagnose: "损伤、中毒的外部原因",
  ...
  constructor(
    ...
    for (let i = 0; i < 9; i++) {
      ...
      this.formData.medRecordOperationInfo.push(tableObj);
    }
  }
      ...
      this.httpReq.post("med_record/list", null, reqObj, (data: any) => {
        if (data["code"] == 0) {
          ...
          if (!_.isNull(backData.id)) {
            for (let i = 0; i < backData.medRecordDiagnoseList.length; i++) {
              backData.medRecordDiagnoseList[i]["diagnoseId"] =
                backData.medRecordDiagnoseList[i]["id"];
              if (!_.isNull(backData.medRecordDiagnoseList[i]["icd10Info"])) {
                backData.medRecordDiagnoseList[i]["icd10InfoId"] =
                  backData.medRecordDiagnoseList[i]["icd10Info"]["id"];
              } else {
                backData.medRecordDiagnoseList[i]["icd10InfoId"] = "";
              }
            }
            ...
            backData.medRecordDiagnoseInfo = newArr;
            backData.medRecordOperationInfo = backData.medRecordOperationList;
