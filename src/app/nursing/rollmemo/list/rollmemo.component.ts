...
@Component({
  selector: "app-rollmemo",
  templateUrl: "rollmemo.component.html"
})
export class RollMemoComponent implements OnInit {
  list;
  page = {
    total: 0,
    size: 10,
  ...
  updateList(reset: boolean = false): void {
    ...
    this.loading = true;
    this.httpReq.post("rollMemo/list1", null, this.reqObj, data => {
      console.log(data);
      this.loading = false;
      if (data["status"] == 200) {
