...
@Component({
  selector: "app-checkOutList2",
  templateUrl: "./checkOutList2.component.html",
  styleUrls: ["./checkOutList2.component.css"]
})
export class CheckOutList2Component implements OnInit {
  page = {
    total: 0,
    size: 10,
    index: 1
