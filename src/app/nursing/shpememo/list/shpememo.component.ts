...
@Component({
  selector: "app-shpememo",
  templateUrl: "shpememo.component.html"
})
export class ShpeMemoComponent implements OnInit {
  list;
  page = {
    total: 0,
    size: 10,
  ...
  updateList(reset: boolean = false): void {
    ...
    this.loading = true;
    this.httpReq.post("shPeMemo/list1", null, this.reqObj, data => {
      console.log(data);
      this.loading = false;
      if (data["status"] == 200) {
