...
@Component({
  selector: "app-weekPlanDetails",
  templateUrl: "./weekPlanDetails.component.html",
  styleUrls: ["./weekPlanDetails.component.css"]
})
export class WeekPlanDetailsComponent implements OnInit {
  // 获取季度的计划列表参数
  listPlanObj = {
    id: "", //记录的ID
    type: "周" //获取哪个计划列表
  ...
  savePlan(data) {
    ...
    this.addPlanDetailsObj.feedback = data.feedback;
