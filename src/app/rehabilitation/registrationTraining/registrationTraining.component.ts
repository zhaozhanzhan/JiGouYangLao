...
@Component({
  selector: "app-registrationTraining",
  templateUrl: "./registrationTraining.component.html",
  styleUrls: ["./registrationTraining.component.css"]
})
export class RegistrationTrainingComponent implements OnInit {
  page = {
    total: 0,
    size: 10,
    index: 1
