...
@Component({
  selector: "app-admission-assessment-JN",
  templateUrl: "./admission-assessment-JN.component.html",
  styleUrls: ["./admission-assessment-JN.component.css"]
})
export class AdmissionassessmentJNComponent implements OnInit {
  list;
  auditStatus;
  page = {
    total: 0,
