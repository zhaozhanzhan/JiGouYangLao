...
@Component({
  selector: "app-addDisabled",
  templateUrl: "./addDisabled.component.html",
  styleUrls: ["./addDisabled.component.css"]
})
export class AddDisabledComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.httpReq.post(
      "/jnyyy_assessment_appay/listDetail",
      null,
      objId,
      data => {
        if (data["status"] == 200) {
