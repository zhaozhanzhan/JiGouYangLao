...
import { CapacityAssessRoutingModule } from "./capacity-assess-routing.module";
...
@NgModule({
  ...
  declarations: [CapacityListComponent, CapacityAddComponent,CapacityDisabledComponent,PrintComponent,PrintContentComponent, PrintDetailsComponent]
})
export class CapacityAssessModule {}
