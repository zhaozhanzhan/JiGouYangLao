...
@Component({
  selector: "app-capacity-disabled",
  templateUrl: "./capacity-disabled.component.html",
  styleUrls: ["./capacity-disabled.component.css"]
})
export class CapacityDisabledComponent implements OnInit {
