...
@Component({
  selector: "app-checkPrint",
  templateUrl: "./checkPrint.component.html",
  styleUrls: ["./checkPrint.component.scss"]
})
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe((params: Params) => {
      ...
      if (infoStr != "{}") {
        ...
        that.tumbleInfo.date = that.formatDate(that.tumbleInfo.date);
        console.log("that.tumbleInfo.date" + that.tumbleInfo.date);
      }
    });
    that.gradeChange();
  }
