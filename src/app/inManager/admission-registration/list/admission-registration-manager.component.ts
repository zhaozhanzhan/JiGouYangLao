...
@Component({
  selector: "app-admission-registration",
  templateUrl: "./admission-registration-manager.component.html",
  styleUrls: ["./admission-registration-manager.component.css"]
})
export class AdmissionRegistrationManagerComponent implements OnInit {
